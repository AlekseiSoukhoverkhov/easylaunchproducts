...
/**
 * Template Loader for Plugins (Base Class).
 *
 * NOTE: This is a customized version of Gamajo_Template_Loader, renamed
 * to EasyProducts_Gamajo_Template_Loader to prevent class name conflicts
 * with other plugins.
 *
 * @package   EasyLaunchProducts
 * @author    EasyProducts Team (based on original work by Gary Jones)
 * @link      http://github.com/GaryJones/Gamajo-Template-Loader
 * @license   GPL-2.0-or-later
 * @version   1.0.0
 */

if ( ! class_exists( 'EasyProducts_Gamajo_Template_Loader' ) ) {
     ...
     * @author  EasyProducts Team
     */
    class EasyProducts_Gamajo_Template_Loader {
        ...
        public function get_template_part( $slug, $name = null, $load = true ) {
            ...
            // Removed generic hook to comply with WP.org requirements

            // Use hardcoded prefix to avoid dynamic hook name warnings
            do_action( 'easyproducts_get_template_part_' . $slug, $slug, $name );
         ...
         * Default is 'data'.
         * @return EasyProducts_Gamajo_Template_Loader
         */
        ...
        protected function get_template_file_names( $slug, $name ) {
             ...
             */
            // Use hardcoded prefix to avoid dynamic hook name warnings
            return apply_filters( 'easyproducts_get_template_part', $templates, $slug, $name );
        }
        ...
        protected function get_template_paths() {
             ...
             */
            // Use hardcoded prefix to avoid dynamic hook name warnings
            $file_paths = apply_filters( 'easyproducts_template_paths', $file_paths );
